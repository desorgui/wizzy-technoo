...
# 📖 [Wizzy-technoo] <a name="about-project"></a>

<!-- > Describe your project in 1 or 2 sentences. -->

**[Wizzy-technoo]** is a Front end template build with Html css and Javascript to Show a list of blog post that can be used to show content about Technology or other type of content.
...
- [Wizzy Techno Link](https://wizzy-techno.netlify.app/)
